...
location String,
crossStreet STRING,
locationOne ARRAY<STRING>
) ROW FORMAT DELIMITED
FIELDS TERMINATED BY '#'
COLLECTION ITEMS TERMINATED BY "|"
STORED AS TEXTFILE
LOCATION '/dataset/crime';
...
COLLECTION ITEMS TERMINATED BY "|"
STORED AS TEXTFILE
LOCATION '/dataset/Price';

create external table schoolDisc (
Ranking INT,
city STRING,
regionname STRING
) ROW FORMAT DELIMITED
...
COLLECTION ITEMS TERMINATED BY "|"
STORED AS TEXTFILE
LOCATION '/dataset/schoolDisc';

create external table income (
RegionName STRING,
state STRING,
income STRING,
level STRING
...
COLLECTION ITEMS TERMINATED BY "|"
STORED AS TEXTFILE
LOCATION '/dataset/business';


create table if not exists 2016price
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '#'
STORED AS TEXTFILE 
LOCATION '/dataset/2016price'
as select RegionName, state, RegionType, JAN2016+FEB2016+MAR2016+APR2016+MAY2016+JUN2016+JUL2016+AUG2016+SEP2016+OCT2016 AS price2016
from price;


create table if not exists 2016pricea
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '#'
STORED AS TEXTFILE 
LOCATION '/dataset/2016pricea'
as select RegionName, state, RegionType, price2016/10 as price2016a
from 2016price;

create table if not exists 20123price
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '#'
STORED AS TEXTFILE 
LOCATION '/dataset/20123price'
as select RegionName, state, RegionType,  JAN2012+FEB2012+MAR2012+APR2012+MAY2012+JUN2012+JUL2012+AUG2012+SEP2012+OCT2012+NOV2012+DEC2012+JAN2013+FEB2013+MAR2013+APR2013+MAY2013+JUN2013+JUL2013+AUG2013+SEP2013+OCT2013+NOV2013+DEC2013 AS price20123
from price;

create table if not exists 20123pricea
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '#'
STORED AS TEXTFILE 
LOCATION '/dataset/20123pricea'
as select RegionName, state, RegionType, price20123/24 as price20123a
from 20123price;

create table if not exists 20067price
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '#'
STORED AS TEXTFILE 
LOCATION '/dataset/2067price'
as select RegionName, state, RegionType,  NOV2006+DEC2006+JAN2007+FEB2007+MAR2007+APR2007+MAY2007+JUN2007+
JUL2007+AUG2007+SEP2007+OCT2007+NOV2007+DEC2007 AS price20067
from price;

create table if not exists 20067pricea
ROW FORMAT DELIMITED 
FIELDS TERMINATED BY '#'
STORED AS TEXTFILE 
LOCATION '/dataset/20067pricea'
as select RegionName, state, RegionType, price20067/14 as price20123a
from 20067price;

create table if not exists laavg
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '#'
STORED AS TEXTFILE 
LOCATION '/dataset/laavg'
as select RegionName, state, RegionType, 
...
from price GROUP BY RegionName, state, RegionType;

create table if not exists latrueavg
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '#'
STORED AS TEXTFILE 
LOCATION '/dataset/latrueavg'
as select 
AVG(NOV2006) AS 2006NOV, AVG(DEC2006) AS 2006DEC,
AVG(JAN2007) AS 2007JAN, AVG(FEB2007) AS 2007FEB, AVG(MAR2007) AS 2007MAR, AVG(APR2007) AS 2007APR, AVG(MAY2007) AS 2007MAY , AVG(JUN2007) AS 2007JUN, AVG(JUL2007) AS 2007JUL, AVG(AUG2007) AS 2007AUG, AVG(SEP2007) AS 2007SEP , AVG(OCT2007) AS 2007OCT, AVG(NOV2007) AS 2007NOV, AVG(DEC2007) AS 2007DEC,
AVG(JAN2008) AS 2008JAN, AVG(FEB2008) AS 2008FEB, AVG(MAR2008) AS 2008MAR, AVG(APR2008) AS 2008APR, AVG(MAY2008) AS 2008MAY , AVG(JUN2008) AS 2008JUN, AVG(JUL2008) AS 2008JUL, AVG(AUG2008) AS 2008AUG, AVG(SEP2008) AS 2008SEP , AVG(OCT2008) AS 2008OCT, AVG(NOV2008) AS 2008NOV, AVG(DEC2008) AS 2008DEC,
...
CREATE TABLE IF NOT EXISTS incomenprice
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '#'
STORED AS TEXTFILE 
LOCATION '/dataset/incomenprice'
as select p.regionname, p.state, p.price2016a, i.income, i.level
FROM 2016pricea p
FULL JOIN  income i
ON (p.regionname = i.regionname);

CREATE TABLE IF NOT EXISTS schoolnprice
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '#'
STORED AS TEXTFILE 
LOCATION '/dataset/schoolnprice'
as select p.regionname, p.state, p.price2016a, s.ranking
FROM 2016pricea p
FULL JOIN  schoolDisc s
ON (p.regionname = s.regionname);

CREATE TABLE IF NOT EXISTS businesspercity
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '#'
STORED AS TEXTFILE 
LOCATION '/dataset/businesspercity'
AS SELECT city, count(city) AS number
FROM business
GROUP BY city;
